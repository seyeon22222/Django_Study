...
import { CollisionBox } from "../phong/object.js";
...
export class Sphere {
    ...
    movePos(pos) {
        let pos_mat = Mat4x4.transportMat(pos);
        this.model = Mat4x4.multipleMat4(pos_mat, this.model);
        this.colbox.moveBox(pos[0], pos[1], pos[2]);
        this.pos = Mat4x4.multipleMat4(pos_mat, this.pos);
    }

    rotSphere(degree) {
        let rot_mat = Mat4x4.rotMatAxisZ(degree);
        this.model = Mat4x4.multipleMat4(rot_mat, this.model);
