...
class Main {
  ...
  static paddle3 = [0, 0, 0];
  static paddle4 = [0, 0, 0];
  static score1 = 0;
  static score2 = 0;
  ...
  static render() {
    ...
    Main.gl.uniformMatrix4fv(
        modelLocation,
        true,
        Mat4x4.transportMat(Main.paddle3)
    );
    ...
    Main.gl.uniformMatrix4fv(
        modelLocation,
        true,
        Mat4x4.transportMat(Main.paddle4)
    );
    ...
    Main.gl.uniformMatrix4fv(
      ...
      true,
      Mat4x4.transportMat([0, -8, 0])
      //Mat4x4.multipleMat4(Mat4x4.transportMat([0, -8, 0]), Mat4x4.rotMatAxisZ(20))
    );
    Main.mesh3.draw(Main.program);
  }
  static update() {
    for (let i = 0; i < 3; i++) {
      ...
      Main.paddle3[i] = Main.stick3.pos[i];
      Main.paddle4[i] = Main.stick4.pos[i];
    }
    Main.render();
    requestAnimationFrame(Main.update);
  }
}
export function game_js(hash) {
